...
class FormBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'form-block',
				'title'             => 'Блок: Форма обратной связи',
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/form-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/form-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
