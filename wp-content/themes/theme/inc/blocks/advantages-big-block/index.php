...
class AdvantagesBigBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'advantages-big-block',
				'title'             => 'Блок: Преимущества (большой)',
				'description'       => 'Преимущества (большой)',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/advantages-big-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/advantages-big-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
