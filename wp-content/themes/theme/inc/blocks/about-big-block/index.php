...
class AboutBigBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'about-big-block',
				'title'             => 'Блок: О нас (большой)',
				'description'       => 'О нас (большой)',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/about-big-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/about-big-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
